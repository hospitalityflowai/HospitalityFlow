# Shift-003 — SPRINT 5 VALIDATION OUTPUT
...
- **open** `amenity:prep` P2 — Prepare champagne + flowers for Josh Piercey-Fisher in Room 51 _(room 51)_
...
2. Prepare champagne + flowers for Josh Piercey-Fisher in Room 51 this shift. _(priority: normal)_ _(owner: Housekeeping)_ _(status: open)_
...
Full machine-readable dump: `shift-003-sprint5.json`
