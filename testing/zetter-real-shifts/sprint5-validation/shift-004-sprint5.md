# Shift-004 — SPRINT 5 VALIDATION OUTPUT
...
- **open** `guest_request:luggage_ea` P2 — Honour luggage / early-arrival arrangements
...
Full machine-readable dump: `shift-004-sprint5.json`
