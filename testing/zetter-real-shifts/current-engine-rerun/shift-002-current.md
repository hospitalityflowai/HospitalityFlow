# Shift-002 — CURRENT POST-SPRINT-4 OUTPUT

**Label:** CURRENT POST-SPRINT-4 OUTPUT

Do **not** confuse with HISTORICAL HF OUTPUT in `../shift-002.md`.
...
5. Arrange extra pillows for Room 21 this shift. _(priority: normal)_ _(owner: Housekeeping)_ _(status: open)_
...
Full machine-readable dump: `shift-002-current.json`
