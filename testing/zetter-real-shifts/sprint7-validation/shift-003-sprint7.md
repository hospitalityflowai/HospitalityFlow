# Shift-003 — Sprint 7 VALIDATION OUTPUT
...
- **open** `amenity:prep` P2 — Prepare champagne for Josh Piercey-Fisher in Room 51 _(room 51)_
...
Priority 3
Prepare champagne for Josh Piercey-Fisher in Room 51.
...
3. Prepare champagne for Josh Piercey-Fisher in Room 51. _(priority: normal)_ _(owner: Housekeeping)_ _(status: open)_
...
Full machine-readable dump: `shift-003-sprint7.json`
