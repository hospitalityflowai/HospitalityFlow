# Shift-001 — Sprint 7 VALIDATION OUTPUT
...
- **open** `timed:airport` P1 — Complete airport / transfer pickup at 11:25 — confirm guest contacts from handover notes _(temporal: today/2026-08-04/11:25)_
...
Priority 2
Complete airport / transfer pickup at 11:25 — confirm guest contacts from handover notes.
...
2. Complete airport / transfer pickup at 11:25 — confirm guest contacts from handover notes. _(priority: high)_ _(owner: Reception)_ _(status: open)_
...
Full machine-readable dump: `shift-001-sprint7.json`
