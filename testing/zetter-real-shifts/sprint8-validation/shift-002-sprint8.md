# Shift-002 — Sprint 8 VALIDATION OUTPUT
...
- **open** `allocation:opera_assign` P1 — Resolve Opera / room allocation for Helene Egebol — Room 32 (assignment unresolved / still shows available) _(room 32)_
- **open** `amenity:prep` P2 — Prepare champagne + fruit + flowers + chocolates for -Gill Beagent in Room 35 _(room 35)_
...
Priority 1
Resolve Opera / room allocation for Helene Egebol — Room 32 (assignment unresolved / still shows available).

Priority 2
Prepare champagne + fruit + flowers + chocolates for -Gill Beagent in Room 35.

Priority 3
Arrange iron and ironing board for Room 34.

Priority 4
Arrange foam pillows for Room 21.
...
1. Resolve Opera / room allocation for Helene Egebol — Room 32 (assignment unresolved / still shows available). _(priority: high)_ _(owner: Reception)_ _(status: open)_
2. Prepare champagne + fruit + flowers + chocolates for -Gill Beagent in Room 35. _(priority: normal)_ _(owner: Housekeeping)_ _(status: open)_
3. Arrange iron and ironing board for Room 34 this shift. _(priority: normal)_ _(owner: Reception)_ _(status: open)_
4. Arrange foam pillows for Room 21 this shift. _(priority: normal)_ _(owner: Housekeeping)_ _(status: open)_
...
Full machine-readable dump: `shift-002-sprint8.json`
