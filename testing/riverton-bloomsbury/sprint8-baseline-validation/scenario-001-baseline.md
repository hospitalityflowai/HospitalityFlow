# Scenario-001 — Riverton Sprint 8 BASELINE OUTPUT
...
- **information** `vip:prep_complete` P3 — Mrs Delgado — VIP prep complete / awareness only _(room 405)_ _(guest Mrs Delgado)_
- **open** `payment:collect` exclude — Collect outstanding payment for Room 214 before departure _(room 214)_ _(guest Mr Ellison)_
...
Full machine-readable dump: `scenario-001-baseline.json`
