# Scenario-006 — Riverton Sprint 8 BASELINE OUTPUT
...
- **open** `payment:collect` exclude — Collect outstanding payment for Room 405 before departure _(room 405)_
...
Full machine-readable dump: `scenario-006-baseline.json`
