# Scenario-014 — Riverton Sprint 8 BASELINE OUTPUT
...
- State counts: {"open":2,"monitor":1,"information":1,"unresolved":0,"blocked":0,"resolved":0,"other":0}

- **open** `payment:collect` P2 — Collect outstanding channel payment for Room 105 before departure _(room 105)_ _(guest -)_
- **open** `payment:collect` P2 — Collect outstanding payment before departure
- **monitor** `payment:tokenise` P2 — Confirm card tokenisation / guarantee before departure _(temporal: information)_
- **information** `payment:insufficient_evidence` P3 — Payment-related note retained — insufficient evidence for collect chase

## AI Summary / Briefing

Priority 1
Collect outstanding channel payment for Room 105 before departure.
...
1. Collect outstanding Expedia payment for Room 105 before departure. _(priority: normal, owner: Reception, status: open)_
2. Collect outstanding payment before departure. _(priority: normal, owner: Reception, status: open)_
3. Collect outstanding balance before departure. _(priority: high, owner: Reception, status: open)_
4. Collect outstanding balance for Room 519 before departure. _(priority: normal, owner: Reception, status: open)_
...
Full machine-readable dump: `scenario-014-baseline.json`
