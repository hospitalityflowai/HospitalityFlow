# Scenario-007 — Riverton Sprint 8 BASELINE OUTPUT
...
- State counts: {"open":4,"monitor":0,"information":0,"unresolved":0,"blocked":0,"resolved":0,"other":0}

- **open** `maintenance` P0 — Follow up maintenance for Room 307 _(room 307)_ _(guest Ms Pell)_ _(temporal: information/inspect)_
- **open** `payment:collect` P2 — Collect outstanding payment for Room 118 before departure _(room 118)_ _(guest -)_
- **open** `payment:collect` P2 — Collect outstanding payment before departure _(guest - Offered)_
...
Priority 2
Collect outstanding payment for Room 118 before departure.
...
2. Collect outstanding £12 balance for Room 118 before departure. _(priority: normal, owner: Reception, status: open)_
3. Collect outstanding payment before departure. _(priority: normal, owner: Reception, status: open)_
4. Follow up with Maintenance regarding Also: corridor light outside 305 flickering…. The fault remains open and needs resolution this shift. _(priority: low, owner: Maintenance, status: open)_
...
Full machine-readable dump: `scenario-007-baseline.json`
