# Scenario-010 — Riverton Sprint 8 BASELINE OUTPUT
...
- **open** `payment:collect` P2 — Collect outstanding channel payment for Room 210 before departure _(room 210)_
...
Priority 2
Collect outstanding channel payment for Room 210 before departure.
...
2. Collect outstanding channel payment for Room 210 before departure. _(priority: normal, owner: Reception, status: open)_
3. Complete the 07:00 wake-up call for Room 320 — wake-up call not yet confirmed as loaded this shift. _(priority: normal, owner: Reception, status: open)_
...
Full machine-readable dump: `scenario-010-baseline.json`
