# Scenario-002 — Riverton Sprint 8 BASELINE OUTPUT
...
- **open** `payment:collect` P2 — Collect outstanding channel payment before departure _(guest Mrs Pendleton)_
...
1. Collect outstanding channel payment before departure. _(priority: normal, owner: Reception, status: open)_
2. Collect outstanding Booking.com payment before departure. _(priority: high, owner: Reception, status: open)_
...
Full machine-readable dump: `scenario-002-baseline.json`
