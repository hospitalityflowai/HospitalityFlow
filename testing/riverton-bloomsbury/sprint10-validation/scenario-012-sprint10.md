# Scenario-012 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **resolved** `superseded` exclude — Superseded current-state fact
...
Full machine-readable dump: `scenario-012-sprint10.json`
