# Scenario-019 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **open** `guest_request:luggage_ea` P2 — Honour luggage / early-arrival arrangements for St Pancras _(guest St Pancras)_ _(temporal: information/10:15)_
...
Full machine-readable dump: `scenario-019-sprint10.json`
