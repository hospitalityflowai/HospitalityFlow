# Scenario-020 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **open** `amenity:prep` P2 — Prepare welcome card for Ms Camille Brennan _(guest Ms Camille Brennan)_
...
- **monitor** `maintenance:tomorrow_inspect` P3 — Monitor mitigated maintenance overnight — escalate only if worsens _(temporal: tomorrow/2026-08-09/inspect)_
- **information** `vip:prep_complete` P3 — Mr Yosef Klein — VIP prep complete / awareness only _(room 228)_ _(guest Mr Yosef Klein)_
- **information** `guest_request:welcome_amenities:declined` P3 — No welcome amenities requested for Room 205 _(room 205)_
- **information** `payment:insufficient_evidence` P3 — Payment-related note retained — insufficient evidence for collect chase
- **resolved** `amenity:twin_done` exclude — Twin setup already complete _(guest Twin For)_
...
Full machine-readable dump: `scenario-020-sprint10.json`
