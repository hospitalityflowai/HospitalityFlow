# Scenario-001 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **information** `timed:late_checkout_not_requested` P3 — Late check-out not requested for Room 308 — standard departure _(room 308)_ _(guest Ms Kaur)_
- **resolved** `guest_request:extra_pillows:done` exclude — extra pillows already completed for Room 119 _(room 119)_ _(guest - Guest)_
- **resolved** `payment:no_collect` exclude — Payment settled / no collect required for Room 214 _(room 214)_ _(guest Mr Ellison)_
- **resolved** `guest_request` exclude — Superseded current-state fact _(room 405)_ _(guest Mrs Delgado)_
...
Full machine-readable dump: `scenario-001-sprint10.json`
