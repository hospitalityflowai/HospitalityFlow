# Scenario-014 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **information** `payment:insufficient_evidence` P3 — Payment-related note retained — insufficient evidence for collect chase
- **resolved** `payment:no_collect` exclude — Payment settled / no collect required for Room 105 _(room 105)_ _(guest -)_
- **resolved** `payment:no_collect` exclude — Payment settled / no collect required for Room 519 _(room 519)_ _(guest -)_
...
Full machine-readable dump: `scenario-014-sprint10.json`
