# Scenario-007 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **monitor** `maintenance:tomorrow_inspect` P3 — Monitor Room 307 overnight — mitigated; escalate only if worsens _(room 307)_ _(guest Ms Pell)_ _(temporal: today/2026-08-08/inspect)_
- **information** `maintenance:cosmetic` P3 — Cosmetic maintenance logged for AM list (information) _(temporal: today/2026-08-08/inspect)_
...
Full machine-readable dump: `scenario-007-sprint10.json`
