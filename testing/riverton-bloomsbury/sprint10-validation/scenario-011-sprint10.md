# Scenario-011 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **resolved** `superseded` exclude — Superseded current-state fact _(room 312)_ _(guest Mr Owen Brennan)_
- **resolved** `superseded` exclude — Superseded current-state fact _(room 312)_ _(guest Mr Owen Brennan)_
- **resolved** `guest_request` exclude — Superseded current-state fact
...
Full machine-readable dump: `scenario-011-sprint10.json`
