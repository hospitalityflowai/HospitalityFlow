# Scenario-004 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **monitor** `maintenance:tomorrow_inspect` P3 — Monitor Room 316 overnight — mitigated; escalate only if worsens _(room 316)_ _(temporal: information/inspect)_
...
Priority 2
Monitor Room 316 overnight — mitigated; escalate only if worsens.
...
1. Honour luggage / early-arrival arrangements for Deluxe King. _(priority: normal, owner: Reception, status: open)_
...
Full machine-readable dump: `scenario-004-sprint10.json`
