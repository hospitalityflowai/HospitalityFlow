# Scenario-008 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **information** `vip:prep_complete` P3 — Dr Simone Albright — VIP prep complete / awareness only _(guest Dr Simone Albright)_
...
Full machine-readable dump: `scenario-008-sprint10.json`
