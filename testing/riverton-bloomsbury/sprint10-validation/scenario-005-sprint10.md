# Scenario-005 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **resolved** `amenity:twin_done` exclude — Twin setup already complete for Room 414 _(room 414)_
- **resolved** `amenity:twin_done` exclude — Twin setup already complete
...
Full machine-readable dump: `scenario-005-sprint10.json`
