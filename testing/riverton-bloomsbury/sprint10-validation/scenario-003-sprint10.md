# Scenario-003 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **information** `payment:insufficient_evidence` P3 — Payment-related note retained — insufficient evidence for collect chase _(room 119)_
- **resolved** `amenity:twin_superseded` exclude — Twin setup superseded — follow final room / double allocation _(guest Deluxe King)_
- **resolved** `payment:no_collect` exclude — Payment settled / no collect required _(guest Ms Naomi Crane)_
...
Full machine-readable dump: `scenario-003-sprint10.json`
