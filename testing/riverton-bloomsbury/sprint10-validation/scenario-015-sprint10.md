# Scenario-015 — RIVERTON SPRINT 10 VALIDATION OUTPUT
...
- **information** `payment:insufficient_evidence` P3 — Payment-related note retained — insufficient evidence for collect chase _(room 415)_ _(guest Mrs Pike)_
- **open** `payment:collect` exclude — Collect outstanding channel payment before departure _(guest Mr Seth Calder)_ _(temporal: today/2026-08-08/collect)_
- **resolved** `payment:no_collect` exclude — Payment settled / no collect required for Room 204 _(room 204)_ _(guest Ms Blum)_
- **resolved** `payment:no_collect` exclude — Payment settled / no collect required for Room 309 _(room 309)_ _(guest Mr Adeyemi)_
...
Full machine-readable dump: `scenario-015-sprint10.json`
