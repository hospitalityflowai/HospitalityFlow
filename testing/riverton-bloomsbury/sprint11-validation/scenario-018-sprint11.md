# Scenario-018 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 018 â Checked-Out Room vs Listed Arrival Conflict
- Shift: AM
- Load: Very busy
- Difficulty: Hard
...
- **open** `occupancy_conflict:clarify` P1 â Confirm room assignment/status for Ms Renata Quill — Room 315 has conflicting arrival/checkout information _(room 315)_ _(guest Ms Renata Quill)_
- **information** `vip:no_active_amenity` P3 â Ms Adebola — No active VIP amenity outstanding _(room 510)_ _(guest Ms Adebola)_
- **resolved** `payment:no_collect` exclude â Payment settled / no collect required

## AI Summary / Briefing

Priority 1
Confirm room assignment/status for Ms Renata Quill — Room 315 has conflicting arrival/checkout information.
...
1. Confirm room assignment/status for Ms Renata Quill — Room 315 has conflicting arrival/checkout information. _(priority: high, owner: Reception, status: open)_
...
Full machine-readable dump: `scenario-018-sprint11.json`
