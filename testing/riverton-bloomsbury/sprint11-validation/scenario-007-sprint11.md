# Scenario-007 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 007 â On-Call Night Engineering
- Shift: Night
- Load: Normal
- Difficulty: Moderate
...
- State counts: {"open":0,"monitor":1,"information":3,"unresolved":0,"blocked":0,"resolved":0,"other":0}

- **monitor** `maintenance:tomorrow_inspect` P3 â Monitor Room 307 overnight — mitigated; escalate only if worsens _(room 307)_ _(guest Ms Pell)_ _(temporal: today/2026-08-08/inspect)_
- **information** `maintenance:cosmetic` P3 â Cosmetic maintenance logged for AM list (information) _(temporal: today/2026-08-08/inspect)_
- **information** `payment:insufficient_evidence` P3 â Payment-related note retained — insufficient evidence for collect chase _(room 118)_ _(guest -)_
- **information** `payment:insufficient_evidence` P3 â Payment-related note retained — insufficient evidence for collect chase _(guest - Offered)_

## AI Summary / Briefing

Priority 1
Monitor Room 307 overnight — mitigated; escalate only if worsens.

Priority 2
Revenue follow-up required for Room 118 outstanding £12 before departures.

Priority 3
Follow up with Maintenance regarding maintenance issue before further guest impact.
...
1. Follow up with Maintenance regarding Also: corridor light outside 305 flickering…. The fault remains open and needs resolution this shift. _(priority: low, owner: Maintenance, status: open)_
...
Full machine-readable dump: `scenario-007-sprint11.json`
