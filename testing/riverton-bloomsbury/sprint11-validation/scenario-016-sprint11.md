# Scenario-016 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 016 â Late Checkout After Midnight Crossing
- Shift: Night
- Load: Busy
- Difficulty: Hard
...
- **open** `guest_request:luggage_ea` P2 â Honour luggage / early-arrival arrangements (Room 114) _(room 114)_ _(temporal: information/06:20)_
- **unresolved** `timed:late_checkout` P2 â Unresolved late check-out today @12 — confirm operational day before actioning _(temporal: ambiguous/12:00)_
...
Full machine-readable dump: `scenario-016-sprint11.json`
