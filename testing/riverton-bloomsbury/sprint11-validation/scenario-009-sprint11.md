# Scenario-009 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 009 â Parlour Afternoon Tea & Room Service Cutoff
- Shift: PM
- Load: Normal
- Difficulty: Moderate
...
- **open** `amenity:prep` P2 â Prepare fruit for Mrs Genevieve Shaw in Room 404 _(room 404)_ _(guest Mrs Genevieve Shaw)_ _(temporal: today/15:30)_
...
Full machine-readable dump: `scenario-009-sprint11.json`
