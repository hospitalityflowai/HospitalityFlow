# Scenario-002 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 002 â Snapshot & Stayovers Only
- Shift: AM
- Load: Quiet
- Difficulty: Basic
...
- **resolved** `payment:no_collect` exclude â Payment settled / no collect required for Room 501 _(room 501)_ _(guest Junior Suite)_
- **resolved** `payment:no_collect` exclude â Payment settled / no collect required for Room 505 _(room 505)_ _(guest Junior Suite)_
- **resolved** `payment:no_collect` exclude â Payment settled / no collect required _(guest Mrs Pendleton)_
...
Full machine-readable dump: `scenario-002-sprint11.json`
