# Scenario-017 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 017 â Arrivals Section Labels Departing Guests
- Shift: PM
- Load: Busy
- Difficulty: Hard
...
- **open** `guest_request:towels` P2 â Arrange towels for Room 214 _(room 214)_ _(guest Mrs Okada)_
- **open** `guest_request:ea_luggage_near` P2 â Honour early arrival / lunch luggage arrangements for Dr Helen Mburu (Room 503) _(room 503)_ _(guest Dr Helen Mburu)_ _(temporal: today/2026-08-09/10:00)_
- **open** `guest_request:luggage_ea` P2 â Honour luggage / early-arrival arrangements _(temporal: today/2026-08-08)_
- **information** `timed:late_checkout` P2 â Late check-out today @12 — timing appears elapsed; retain as information (Room 306) _(room 306)_ _(guest Mr Tomasz Weller)_ _(temporal: past/2026-08-08/12:00)_
- **open** `amenity:twin` P3 â Prepare twin beds for Room 108 (Mr Chris Vale) _(room 108)_ _(guest Mr Chris Vale)_
- **resolved** `payment:no_collect` exclude â Payment settled / no collect required for Room 411 _(room 411)_ _(guest Ms Priya Nair)_
...
Full machine-readable dump: `scenario-017-sprint11.json`
