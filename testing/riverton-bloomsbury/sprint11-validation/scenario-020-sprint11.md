# Scenario-020 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 020 â Adversarial Paste — Everything Competing
- Shift: Night
- Load: Very busy
...
- State counts: {"open":3,"monitor":1,"information":3,"unresolved":1,"blocked":0,"resolved":3,"other":0}

- **open** `timed:airport` P1 â Complete airport / transfer pickup at 06:40 — Lutz Heathrow _(guest Lutz Heathrow)_ _(temporal: information/06:40)_
- **open** `amenity:prep` P2 â Prepare welcome card for Ms Camille Brennan _(guest Ms Camille Brennan)_
- **unresolved** `timed:airport_fragment` P2 â Unresolved airport / transfer follow-up — confirm guest, room, and pickup time _(room 210)_ _(guest Luton)_ _(temporal: information)_
- **open** `guest_request:luggage_ea` P2 â Honour luggage / early-arrival arrangements _(temporal: information/15:10)_
- **monitor** `maintenance:tomorrow_inspect` P3 â Monitor OOO room — not released / not sellable until engineering confirms _(temporal: tomorrow/2026-08-09/inspect)_
- **information** `vip:prep_complete` P3 â Mr Yosef Klein — VIP prep complete / awareness only _(room 228)_ _(guest Mr Yosef Klein)_
- **information** `guest_request:welcome_amenities:declined` P3 â No welcome amenities requested for Room 205 _(room 205)_
- **information** `payment:insufficient_evidence` P3 â Payment-related note retained — insufficient evidence for collect chase
- **resolved** `amenity:twin_done` exclude â Twin setup already complete _(guest Twin For)_
- **resolved** `guest_request` exclude â Superseded current-state fact _(guest Mr Yosef Klein)_
- **resolved** `superseded` exclude â Superseded current-state fact _(room 228)_ _(guest Mr Yosef Klein)_
...
Priority 2
Prepare welcome card for Ms Camille Brennan.
...
2. Prepare welcome card for Ms Camille Brennan. _(priority: normal, owner: Reception, status: open)_
3. Honour luggage / early-arrival arrangements. _(priority: normal, owner: Reception, status: open)_
4. Complete the 07:00 wake-up call for Room 320 — wake-up call not yet confirmed as loaded this shift. _(priority: normal, owner: Reception, status: open)_
...
Full machine-readable dump: `scenario-020-sprint11.json`
