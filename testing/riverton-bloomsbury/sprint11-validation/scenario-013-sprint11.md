# Scenario-013 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 013 â Anniversary Package Then Cancellation
- Shift: AM
- Load: Normal
- Difficulty: Moderate
...
- **open** `amenity:prep` P2 â Prepare truffles + chocolates + welcome card _(temporal: today/11:20)_
- **open** `amenity:prep` P2 â Prepare truffles + welcome card
- **open** `amenity:prep` P3 â Prepare truffles
- **information** `vip:no_active_amenity` P3 â Mrs Langford — No active VIP amenity outstanding _(guest Mrs Langford)_
...
Full machine-readable dump: `scenario-013-sprint11.json`
