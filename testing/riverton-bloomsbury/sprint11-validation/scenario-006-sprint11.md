# Scenario-006 â RIVERTON SPRINT 11 VALIDATION OUTPUT
...
## Run metadata
- Scenario: 006 â OOO Corridor — Guest Impact vs Housekeeping
- Shift: AM
- Load: Busy
- Difficulty: Hard
...
- State counts: {"open":1,"monitor":1,"information":0,"unresolved":0,"blocked":0,"resolved":1,"other":0}

- **open** `allocation:blocked_assigned` P1 â Clarify / reallocate arrival for Ms Yuen — assigned Room 218 is unavailable or blocked (do not invent a replacement room) _(room 218)_ _(guest Ms Yuen)_
- **monitor** `maintenance:tomorrow_inspect` P3 â Monitor OOO Room 218 — not released / not sellable until engineering confirms _(room 218)_ _(temporal: today/2026-08-08/inspect)_
- **resolved** `maintenance` exclude â Superseded current-state fact _(room 220)_

## AI Summary / Briefing

Priority 1
Clarify / reallocate arrival for Ms Yuen — assigned Room 218 is unavailable or blocked (do not invent a replacement room).

Priority 2
Monitor OOO Room 218 — not released / not sellable until engineering confirms.
...
1. Monitor OOO Room 218 — not released / not sellable until engineering confirms. _(priority: high, owner: Maintenance, status: open)_
...
Full machine-readable dump: `scenario-006-sprint11.json`
