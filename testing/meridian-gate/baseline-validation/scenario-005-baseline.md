# Scenario-005 — MERIDIAN GATE FIRST-RUN BASELINE OUTPUT
...
- **open** `guest_request:iron_and_ironing_board` P2 — Arrange iron and ironing board
...
1. Arrange iron and ironing board. _(priority: normal)_
...
Full dump: `scenario-005-baseline.json`
