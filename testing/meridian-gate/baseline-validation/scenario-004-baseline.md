# Scenario-004 — MERIDIAN GATE FIRST-RUN BASELINE OUTPUT
...
- **open** `guest_request:luggage_ea` P2 — Honour luggage / early-arrival arrangements for Ms Trent _(guest Ms Trent)_ _(temporal: information/09:15)_
- **resolved** `payment:no_collect` exclude — Payment settled / no collect required _(guest Ms Brennan)_

## AI Summary / Briefing

Priority 1
Honour luggage / early-arrival arrangements for Ms Trent.

## Recommendations

1. Honour luggage / early-arrival arrangements for Ms Trent. _(priority: normal)_
...
Full dump: `scenario-004-baseline.json`
