# Scenario-020 — MERIDIAN GATE FIRST-RUN BASELINE OUTPUT
...
- **open** `payment:collect` P2 — Collect outstanding payment before departure _(guest Mr Holt)_ _(temporal: today/2026-09-25/collect)_
- **unresolved** `amenity:conditional` P3 — Confirm availability before preparing champagne
...
Priority 2
Timed departure actions for wake-up at 04:30.

Priority 3
Collect outstanding payment before departure.

Priority 4
Revenue follow-up required for outstanding £42.50 before departures.

## Recommendations

1. Collect outstanding payment before departure. _(priority: normal)_
2. Collect outstanding balance before departure. _(priority: high)_
3. Complete the 04:30 wake-up call — wake-up call not yet confirmed as loaded this shift. _(priority: high)_
...
Full dump: `scenario-020-baseline.json`
