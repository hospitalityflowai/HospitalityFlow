# Scenario-003 — MERIDIAN GATE FIRST-RUN BASELINE OUTPUT
...
- **resolved** `payment:no_collect` exclude — Payment settled / no collect required _(guest Mr Dudley)_
...
2. Complete the 05:20 wake-up call — wake-up call not yet confirmed as loaded this shift. _(priority: high)_
...
Full dump: `scenario-003-baseline.json`
