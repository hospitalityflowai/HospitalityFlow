# Scenario-005 ? MERIDIAN GATE Sprint 15 state-resolution validation OUTPUT
...
- State counts: {"open":0,"monitor":0,"information":0,"unresolved":0,"blocked":0,"resolved":1,"other":0}

- **resolved** `guest_request:iron_and_ironing_board:done` exclude ? iron and ironing board already completed for Room M203 _(room M203)_
...
Full dump: `scenario-005-sprint15.json`
