# Scenario-003 � MERIDIAN GATE Sprint 13 invalid-inventory validation OUTPUT
...
Priority 2
Complete wake-up / transfer actions for Room cx12 before departure.

Priority 3
Complete wake-up / transfer actions for Room m212 before departure.

## Recommendations

1. Follow up with Maintenance regarding MAINTENANCE. The fault remains open and needs resolution this shift. _(priority: high)_
2. Complete the 05:20 wake-up call for Rooms M212, M215 — wake-up call not yet confirmed as loaded this shift (Room M212). _(priority: high)_
...
Full dump: `scenario-003-sprint13.json`
