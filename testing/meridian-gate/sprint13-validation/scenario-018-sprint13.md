# Scenario-018 � MERIDIAN GATE Sprint 13 invalid-inventory validation OUTPUT
...
- **open** `allocation:invalid_configuration` P1 � Clarify / reallocate for Mrs Okada — Rooms M152 & CX10 are not a valid interconnect configuration (do not invent a replacement pair) _(room M152)_ _(guest Mrs Okada)_
- **information** `reservation_info` P3 � Reservation / POA information (not VIP prep)

## AI Summary / Briefing

Priority 1
Clarify / reallocate for Mrs Okada — Rooms M152 & CX10 are not a valid interconnect configuration (do not invent a replacement pair).

## Recommendations

1. Clarify / reallocate for Mrs Okada — Rooms M152 & CX10 are not a valid interconnect configuration (do not invent a replacement pair). _(priority: high)_
...
Full dump: `scenario-018-sprint13.json`
