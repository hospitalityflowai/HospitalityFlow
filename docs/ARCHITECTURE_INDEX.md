...
| **Guest Intelligence** | GI-3 foundation — observations, candidates, staff review pathway ([architecture](GUEST_INTELLIGENCE_ARCHITECTURE.md)); schema proposed, not applied |
...
Guest Intelligence (GI-3 review foundation) → same engine contracts, not a parallel brain
```
...
| [GUEST_INTELLIGENCE_ARCHITECTURE.md](GUEST_INTELLIGENCE_ARCHITECTURE.md) | Guest Intelligence GI-0–GI-3 — observations, candidates, review foundation |
...
| **Guest Intelligence** | [GUEST_INTELLIGENCE_ARCHITECTURE.md](GUEST_INTELLIGENCE_ARCHITECTURE.md) (GI-3: `guest-intelligence.js` + proposed `phase17_guest_knowledge.sql`; not applied) |
...
| Guest Intelligence | **GI-3 foundation done** — review pathway + proposed schema (not applied); no profile UI / no auto-confirm; reuse E4 contracts |
